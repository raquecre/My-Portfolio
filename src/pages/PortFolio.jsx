...
const Portfolio = () => {
    ...
    return (
        <div className="bg-white bg-opacity-50 shadow-lg rounded">
            <div className="headerPortfolio flex justify-between p-5" >
            ...
            <div>
                <CardPorfolio nameProyect="Pokedex" descriptionProyect='prueba prueba prueba prueba prueba' urlImageProyect={pokedexImage}/>
            </div>
