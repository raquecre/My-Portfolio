...
const Footer = () => {
    return (
        <div className="w-[800px] bg-white bg-opacity-90 shadow-lg rounded-lg mt-12 p-5 gap-6  ">
            <>
                <p className="text-3xl font-bold text-transparent bg-gradient-to-r from-blue-400 to-purple-400  bg-clip-text "> Hablemos</p>
            </>
            <div className=" flex gap-3 hover:underline inline-block hover:text-blue-400 font-bold text-transparent bg-gradient-to-r from-blue-400 to-purple-400  bg-clip-text hover:italic hover:underline  p-3 ">
                <svg class="w- h-5"
            ...
            <div className="flex  justify-around">
                <div className="TEXTO flex flex-col  ">
                    ...
                    <div className="flex justify-start mb-7">
                        ...
                        <div className="w-fit flex hover:underline hover:text-blue-700 hover:italic rounded-lg bg-gradient-to-r from-blue-400 to-purple-400 m-3 p-1">
                            <div className="w-fit flex items-center rounded-lg bg-white bg-opacity-90 text-sm p-1">
                    ...
                    <div className="flex justify-start mb-7 m-2">
                        <div div className="QR flex justify-around">
                            <div className="flex items-center justify-start gap-10">
                                <div className=" ">
                                    <img className="w-10" src="https://i.imgur.com/XBmRQbx.png" />
                            ...
                            <div className="flex justify-around">
                                <div className="">
                                    <img className="w-10" src="https://i.imgur.com/ovuBIY5.png" />
                ...
                <div className=" w-80 rounded-full  flex justify-center border-5 border-blue-400 rounded-full ">
                   <ProfileImg/>
                </div>
            </div>
